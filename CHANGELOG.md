...
New : The About menu now contains a "Check Environment" option (Windows only, disabled for Linux and OSX) that scans for DLLs, reports database information etc. 

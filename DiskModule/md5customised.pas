{
 This is a customised version of the FPC 'md5' library.
...
{ New version of MD5Transform, also courtesy of EngKin at the forums.
 We have adopted the same theory as used for SHA1Transform.
 In tests, the enhanced pascal MD5Transform procedure is ~3 times faster than the
 native Freepascal core function. The assembly compiled version is around 5 times faster
 The original version (as of FPC 2.6.4) is left below commented out.
 The pascal enhanced version is left below and also commented out in favour of the assembly version.

 The assembly version of the MD5 Transfrom procedure, which has now been added to FPC 2.7.1
 http://bugs.freepascal.org/view.php?id=26545
}
{ // Remove this bracket to use assmbly version on enhanced transform
{$ASMMODE Intel}
{$I MD5TransformEnhancedAssemblyCodei386.inc} // complete assembly version of the enhanced transform procedure
} // Remove this bracket to use assmbly version on enhanced transform

// Comment this out to try the assembly coded version above. This is the enhanced MD5Transform in Freepascal syntax
...
{$I MD5TransformEnhanced.pas};  //<---- The new version of the repeat loops. Makes MD5Transform ~ 3 times faster!
...
{ // Uncomment this to use the native FreePascal 2.6.4 coded version of MD5Transform
procedure MD5Transform(var Context: TMDContext; Buffer: Pointer);
...
// Customised version of MDFile. It enables FPC to deal with the ANSI Code Pages
